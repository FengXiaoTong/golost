...
@interface STPickerHomeArea()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation STPickerHomeArea
...
- (void)selectedOk
{
    [self.delegate pickerHomeArea:self province:self.province city:self.city area:self.area];
    [self remove];
}

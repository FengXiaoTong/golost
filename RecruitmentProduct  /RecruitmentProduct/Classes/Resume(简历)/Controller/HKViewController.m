...
@interface HKViewController ()<UIPickerViewDelegate, UIPickerViewDataSource>
...
- (void)viewDidLoad
{
    [super viewDidLoad];
    [self addRightItem];
    _pickerView = [[UIPickerView alloc]initWithFrame:CGRectMake(0, 300, screenW, screenH-364)];
...
-(void)addRightItem
{
    self.navigationItem.title = @"户口所在地";

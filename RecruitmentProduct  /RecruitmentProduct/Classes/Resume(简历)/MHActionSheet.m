...
{
    _titleView.headLabel.font = [UIFont systemFontOfSize:15.0];
}

- (void)setTitleTextColor:(UIColor *)titleTextColor
{
    if (titleTextColor) {
        _titleView.headLabel.textColor = [UIColor blackColor];
    }
}
...
{
    if (itemTextFont) {
        _sheetView.cellTextFont = [UIFont systemFontOfSize:15.0];
    }
}
...
{
    if (itemTextColor) {
        _sheetView.cellTextColor = [UIColor blackColor];
    }
}
...
//    dict[@"titleName"] = title;
//    [[NSNotificationCenter defaultCenter] postNotificationName:@"titleName" object:dict];
